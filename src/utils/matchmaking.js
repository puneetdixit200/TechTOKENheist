 ...
 * Standard mode enforces allocation/history caps. Both modes prevent
 * consecutive repeat domains for either team.
 */
export function getValidDomains({ teamA, teamB, matchConstraints, allDomains, phase = 'phase1' }) {
