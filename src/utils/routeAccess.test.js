...
test('player startup uses the original Hindi and English Infinite Void animation', () => {
  const app = readProjectFile('src/App.jsx')
  ...
  assert.doesNotMatch(matchStartOverlay, /loading-video-bg/)
  ...
  assert.doesNotMatch(matchStartCss, /loading-video-bg/)
