 ...
 * members, and a randomised password that persists across game resets.
 *
 * ⚠️  Passwords are also stored in the Supabase `teams` table.
 *     This file is the authoritative source used by the seed/create-all script.
 */
